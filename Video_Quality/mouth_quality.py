...
def compute_mouth_quality(video_path, start_frame, end_frame, model):
    try:
        ...
        if not valid_mouths:
            return None
        scores = model.score([valid_mouths], task_="quality", input_="video")
    ...
    with open(output_path, 'w') as f:
        ...
        for video_path in tqdm(video_paths, desc="Processing Videos"):
            ...
            for seg_num in range(NUM_SEGMENTS):
                ...
                score = compute_mouth_quality(video_path, start, end, model)
                if score is None:
                    continue
...
# python mouth_quality.py --video_txt ../input.txt --output_txt output.txt
